<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Her kan du opdatere din profil information som email og navn') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="name" value="{{ __('Navn') }}" />
